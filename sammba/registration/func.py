...
class FuncSession(object):
    ...
    def coregister(self, use_rats_tool=True,
        ...
        allineated_filename, mean_aligned_filename, _ = \
            _realign(func_filename, self.output_dir, caching=caching,
...
@deprecated("Function 'coregister_fmri_session' has been replaced by "
            "method 'coregister' of class 'FuncSession' and will be removed "
            "in future release. ")
...
@deprecated("Function 'fmri_sessions_to_template' has been replaced by "
            "function '_transform_to_template' and will be "
...
@deprecated("Function 'fmri_sessions_to_template' has been replaced by "
            "method 'register_to_template' of class 'FuncSession' and will be "
            "removed in future release. ")
