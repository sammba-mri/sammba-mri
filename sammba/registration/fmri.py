...
from .multimodal import (extract_brain, _rigid_body_register, _warp,
                         _per_slice_qwarp)
from .utils import copy_geometry
...
class FMRISession(object):
    ...
    def coregister(self, t_r, brain_volume, write_dir, use_rats_tool=True,
                   slice_timing=True,
        ...
        if prior_rigid_body_registration:
            anat_brain_filename = extract_brain(
                unbiased_anat_filename, write_dir, brain_volume,
    ...
    def register_to_template(self, t_r, brain_volume, head_template_filename,
        ...
        See also
        --------
        sammba.registration.coregister,
        sammba.registration.anats_to_template
        """
        self._check_inputs()
